...
public enum Lodestone {
     ...
     */
    public boolean isActive(IMethodContext ctx) {
        return ctx.widgets.get(1092, child).getTextureId() < 10117;
    }

    public void teleport(IMethodContext ctx) {
